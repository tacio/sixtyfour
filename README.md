...
| `specimen.html` | Interactive specimen: live encoder, the full matrix, the spoken names, a section set entirely in the colourless face, a Light / Dark / Auto control, a both-grounds panel, and a switch that drops the colour so you can check the hatch on its own. |
...
uv run pytest                # 54 checks, including the hatch ink ramp
```
